...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { CategoryId: @phrase.CategoryId, Chinese: @phrase.Chinese, English: @phrase.English, Spanish: @phrase.Spanish }
    end
  ...
  test "should update phrase" do
    put :update, id: @phrase, phrase: { CategoryId: @phrase.CategoryId, Chinese: @phrase.Chinese, English: @phrase.English, Spanish: @phrase.Spanish }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
